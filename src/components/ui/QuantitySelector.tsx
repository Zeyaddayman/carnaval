    ...
    return (
        <Listbox value={quantity} onChange={setQuantity}>
            <div onClick={handlePlacement} ref={selectorRef} className="relative min-w-30 flex-1">
                <ListboxButton className="relative h-9 w-full flex justify-center items-center cursor-default rounded-md bg-input py-3 pl-3 pr-10 text-left border border-border focus-visible:outline-none focus-visible:ring-3 focus-visible:ring-primary sm:text-sm/6">
