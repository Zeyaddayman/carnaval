...
const PasswordInput = ({ ...props }: React.ComponentProps<"input">) => {
    ...
    return (
        <div className="relative">
            ...
            />
            <span
                className="absolute p-1 end-2 top-1/2 -translate-y-1/2 cursor-pointer"
                onClick={toggleType}
            >
